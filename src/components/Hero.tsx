        ...
        <div className="flex-1 w-full flex flex-col justify-end lg:justify-center pb-12 md:pb-8 pt-32 lg:pt-56">
          ...
          >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="px-8 py-5 md:px-6 md:py-4 bg-white/10 backdrop-blur-md text-white border border-white/30 text-[10px] md:text-[10px] font-medium uppercase tracking-[0.2em] transition-all duration-500 shadow-2xl drop-shadow-[0_4px_10px_rgba(0,0,0,0.5)] w-full sm:w-fit rounded-sm"
            >
              Explore Collection
            </motion.button>
          </motion.div>
